const AUTH0_CLIENT_ID = "0zgH35VY2Uk7xMqu8k0nfQp97A0EW1cp";
const AUTH0_DOMAIN = "tdmadison.auth0.com";
        ...
        <div className="row">
          <div className="container">
            {this.state.jokes.map((joke, i) => {
              return <Joke key={i} joke={joke} handleLike={this.handleLike} />;
            })}
          </div>
        </div>
      </div>
...
class Joke extends React.Component {
  ...
  like() {
    const { joke, handleLike } = this.props;
    handleLike(joke)
      .then(mssg => {
        this.setState({
          liked: mssg
